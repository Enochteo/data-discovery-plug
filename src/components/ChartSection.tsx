      ...
      <Card>
        ...
        <CardContent>
          <p className="text-gray-500 text-center py-8">
            No numeric columns found for visualization. Upload a dataset with
            numeric or time-series fields to generate charts.
          </p>
          <p className="text-xs text-muted-foreground text-center">
            Tip: convert numeric-looking strings to numbers or ensure your CSV
