...
const InsightsPanel = ({
  ...
  const handleGenerateInsight = () => {
    ...
    fetch("http://localhost:4000/insight", {
      ...
      body: JSON.stringify({
        prompt: `Generate insights for the following dataset: ${JSON.stringify(
          data
        )}`,
      }),
    })
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-gray-500 text-center py-8">
            No insights available yet. Upload a CSV or visit the Data tab to
            review your dataset and generate automated analysis.
          </p>
          <div className="text-center">
            <p className="text-xs text-muted-foreground">
              Tip: insights are generated from numeric and time-based columns.
            </p>
          </div>
